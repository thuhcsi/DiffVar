"""
Adapted from https://github.com/NATSpeech/NATSpeech/blob/238165e8cd430531b69c484cabb032c1313ee73b/modules/tts/diffspeech/net.py
"""
...
class DiffNet(nn.Module):
    def __init__(self, in_dims, hidden_size, residual_layers, 
                 residual_channels, dilation_cycle_length):
        super().__init__()
